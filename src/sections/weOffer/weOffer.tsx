                ...
                <div className="we-offer-plate plate">
                    <div className="we-offer-plate-info-block">
                        <div className="we-offer-plate-title">
                            Solid <br className='laptop'/> wood <br className='laptop'/> products
                        </div>
                    ...
                    <div className="we-offer-plate-line-wrapper laptop">
                        <img className='we-offer-line' src="/images/line.png" alt="" />
                    </div>
                    <div className="we-offer-plate-images-block laptop">
